...
const pages = [
  {
    ...
    cards: [
      { icon: Search,    title: "Знаходить групи",   desc: "Шукає публічні групи та канали за ключовим словом з фільтрами за кількістю учасників і типом." },
      { icon: Users,     title: "Автовступ у групи", desc: "Автоматично вступає у знайдені групи від вашого імені з випадковою затримкою між запитами." },
      { icon: Megaphone, title: "Масова розсилка",   desc: "Надсилає ваше повідомлення у всі збережені групи за заданим розкладом або одним запуском." },
    ],
  },
  {
    badge: "Як це працює",
    ...
    cards: [
      { icon: Search,    title: "Пошук груп",      desc: "Публічні групи й канали за ключовим словом, з фільтрами за мінімальною та максимальною кількістю учасників." },
      { icon: Clock,     title: "Гнучкий розклад", desc: "Щогодини, кожні 2, 4, 8 або 12 годин, щодня — або встановіть довільний інтервал у хвилинах." },
      { icon: Megaphone, title: "Кампанії",         desc: "Запускайте, призупиняйте та відстежуйте статус і статистику кожної розсилки окремо." },
      { icon: Users,     title: "Збережені групи",  desc: "Масово обирайте групи зі списку й вступайте в усі одним натисканням кнопки." },
    ],
  },
  {
    badge: "Авторизація",
    ...
    cards: [
      { icon: Smartphone,  title: "Номер телефону",    desc: "Введіть номер у форматі +380... — Telegram надішле код підтвердження прямо у застосунок." },
      { icon: KeyRound,    title: "Підтвердіть код",   desc: "Введіть 5-значний код із Telegram. Якщо увімкнено 2FA — також знадобиться хмарний пароль." },
      { icon: ShieldCheck, title: "Сесія збережена",   desc: "Повторно авторизуватись не потрібно — сесія зберігається навіть після перезапуску сервера." },
      { icon: ArrowRight,  title: "Business / Premium", desc: "Рекомендується для масових дій — знижує ризик тимчасових обмежень з боку Telegram." },
    ],
  },
];
